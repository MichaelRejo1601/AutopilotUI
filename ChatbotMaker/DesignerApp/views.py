...
def edit_actions(request, assistant_sid, task_sid):
    ...
    try:
        ...
        print("Yikes Dawg")
    options = {
        "say":"<section id='say' class='panel'> <header class='panel-heading'> <a id='arrow-up' class='arrow'>&#8679;</a> <a id='arrow-down' class='arrow'>&#8681;</a> <strong style='font-size: 2rem;'>Say</strong> <button class='btn btn-primary' style='border-color:#d9534f; background-color: #F7F7F7; color:#d9534f; float:right; line-height:50%; margin-top:7px;'><strong>remove</strong></button> </header><div class='panel-body'><form class='form-horizontal' method='post'><div class='form-group'> <label class='col-sm-2 control-label'>Text</label><div class='col-sm-10'> <input required name='actions[0][say][speech]' type='text' class='form-control' placeholder='Hello there! How may I help you?'></div></div></form></div> </section>",
        "play":"<section id='play' class='panel'> <header class='panel-heading'> <a id='arrow-up' class='arrow'>&#8679;</a> <a id='arrow-down' class='arrow'>&#8681;</a> <strong style='font-size: 2rem;'>Play</strong> <button class='btn btn-primary' style='border-color:#d9534f; background-color: #F7F7F7; color:#d9534f; float:right; line-height:50%; margin-top:7px;'><strong>remove</strong></button> </header><div class='panel-body'><form class='form-horizontal ' method='post'><div class='form-group'> <label class='col-sm-2 control-label'>URL</label><div class='col-sm-10'> <input required name='actions[1][play][url]' type='url' class='form-control' placeholder='https://wwww.mysite.com/song.mp3'></div></div><div class='form-group'> <label class='col-sm-2 control-label'>Loop</label><div class='col-sm-10'> <input required name='actions[1][play][loop]' type='number' class='form-control' placeholder='1'></div></div></form></div> </section>",
        "listen":"<section id='listen' class='panel'> <header class='panel-heading'> <a id='arrow-up' class='arrow'>&#8679;</a> <a id='arrow-down' class='arrow'>&#8681;</a> <strong style='font-size: 2rem;'>Listen</strong> <button class='btn btn-primary' style='border-color:#d9534f; background-color: #F7F7F7; color:#d9534f; float:right; line-height:50%; margin-top:7px;'><strong>remove</strong></button> </header><div class='panel-body'><form class='form-horizontal ' method='post'><div class='form-group'> <label class='col-sm-2 control-label'>Tasks</label><div class='col-sm-9'> <input id='tasks' name='actions[2][listen][tasks][]' type='text' class='form-control' placeholder='Task-1'></div><div class='col-sm-1'> <button class='btn btn-primary' style='border-color:#d9534f; background-color: #F7F7F7; color:#d9534f; float:left; line-height:50%; margin-top:7px;'><strong>-</strong></button></div><div class='col-sm-2'></div><div class='col-sm-9'> <input id='tasks' name='actions[2][listen][tasks][]' type='text' class='form-control' placeholder='mytask-x'></div><div class='col-sm-1'> <button class='btn btn-primary' style='border-color:#d9534f; background-color: #F7F7F7; color:#d9534f; float:left; line-height:50%; margin-top:7px;'><strong>-</strong></button></div><div class='col-sm-2'></div><div class='col-sm-9'></div><div class='col-sm-1'> <button class='btn btn-primary' style='border-color:#688a7e; background-color: #F7F7F7; color:#688a7e; margin-top:10px;'><strong>+</strong></button></div></div></form></div> </section>",
        "handoff":"<section id='handoff' class='panel'> <header class='panel-heading'> <a id='arrow-up' class='arrow'>&#8679;</a> <a id='arrow-down' class='arrow'>&#8681;</a> <strong style='font-size: 2rem;'>Handoff</strong> <button class='btn btn-primary' style='border-color:#d9534f; background-color: #F7F7F7; color:#d9534f; float:right; line-height:50%; margin-top:7px;'><strong>remove</strong></button> </header><div class='panel-body'><form class='form-horizontal ' method='post'><div class='form-group'> <label class='col-sm-2 control-label'>Chanel</label><div class='col-sm-9'> <select name='actions[1][handoff][chanel]' class='form-control m-bot15'><option>Voice</option><option>Text</option> </select></div><div class='col-sm-1'> <button class='btn btn-primary' style='border-color:#d9534f; background-color: #F7F7F7; color:#d9534f; float:left; line-height:50%; margin-top:7px;'><strong>-</strong></button></div></div><div class='form-group'> <label class='col-sm-2 control-label'>TwiML URL</label><div class='col-sm-10'> <input required name='actions[3][handoff][url]' type='url' class='form-control' placeholder='https://wwww.mysite.com/song.mp3'></div></div><div class='form-group'> <label class='col-sm-2 control-label'>Method</label><div class='col-sm-10'> <select name='actions[1][handoff][methpd]' class='form-control m-bot15'><option>GET</option><option>POST</option> </select></div></div></form></div> </section>",
        "redirect":"<section id='handoff' class='panel'> <header class='panel-heading'> <a id='arrow-up' class='arrow'>&#8679;</a> <a id='arrow-down' class='arrow'>&#8681;</a> <strong style='font-size: 2rem;'>Redirect</strong> <button class='btn btn-primary' style='border-color:#d9534f; background-color: #F7F7F7; color:#d9534f; float:right; line-height:50%; margin-top:7px;'><strong>remove</strong></button> </header><div class='panel-body'><form class='form-horizontal ' method='post'><div class='form-group'> <label class='col-sm-2 control-label'>URL</label><div class='col-sm-10'> <input required name='actions[3][redirect][url]' type='url' class='form-control' placeholder='https://wwww.mysite.com/song.mp3'></div></div><div class='form-group'> <label class='col-sm-2 control-label'>Method</label><div class='col-sm-10'> <select name='actions[1][redirect][method]' class='form-control m-bot15'><option>GET</option><option>POST</option> </select></div></div></form></div> </section>",
    }
    options1 = {
...
def edit_samples(request, assistant_sid, task_sid):
    ...
    samples = client.autopilot \
        .assistants(assistant.sid) \
        .tasks(task_sid).samples.list()
    fields = client.autopilot \
        .assistants(assistant.sid).field_types.list()
    print("sid" + task.sid)
    context = {'assistant':assistant, 'task':task, 'samples':samples, 'fields':fields}
